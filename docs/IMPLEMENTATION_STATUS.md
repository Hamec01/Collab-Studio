...
- Active slice: Stage 1 final audit (router/state boundaries)
...
Stage 2 (не начинать без отдельного подтверждения):

1. i18n, design tokens и responsive shell по канонической карте.
2. Без schema/public redesign вне scope Stage 2.
